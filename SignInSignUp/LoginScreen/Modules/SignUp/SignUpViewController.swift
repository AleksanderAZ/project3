...
class SignUpViewController: UIViewController, SignUpViewProtocol {
    ...
    @IBOutlet weak var confirmTextFild: UITextField!
    ...
    func configTextFild() {
        ...
        confirmTextFild.layer.borderColor = UIColor.red.cgColor
        loginTextFild.layer.borderWidth = 0
        passwordTextFild.layer.borderWidth = 0
        confirmTextFild.layer.borderWidth = 0
        ...
        confirmTextFild.delegate = self
        passwordTextFild.restorationIdentifier = RestorationIdentifierTextField.password.string
        confirmTextFild.restorationIdentifier = RestorationIdentifierTextField.password.string
    ...
    func setTittleConfirmButtonShow() {
        DispatchQueue.main.async {
            self.showConfirmButton.setTitle("🔓", for: .normal)
        }
    }
    ...
    @IBAction func clickShowConfirmButton(_ sender: UIButton) {
        confirmTextFild.text = presenter?.changeStatusHideConfirm()
    }
    ...
    @IBAction func changedConfirmTextField(_ sender: UITextField) {
        guard let passwordNew = sender.text else { return }
        presenter?.setConfirm(confirm: passwordNew)
        guard let passwordShow = presenter?.getConfirmForShow() else { return }
        sender.text = passwordShow
    }
    ...
    @IBAction func clickLoginButton(_ sender: UIButton) {
        ...
        confirmTextFild.resignFirstResponder()
    ...
    func switchLoginButton(isHide: Bool, errorText: String) {
        ...
        guard let errorTextFildConfirm = self.confirmTextFild else { return }
        switchView(isHide: isHide, view: switchview, errorTextFild: errorTextFildConfirm, errorText: errorText)
    }
    ...
    func switchConfirmTextFild(isHide: Bool, errorText: String) {
        guard let switchview = self.confirmView  else { return }
        guard let errorTextFild = self.loginTextFild else { return }
        switchView(isHide: isHide, view: switchview, errorTextFild: errorTextFild, errorText: errorText)
    }
    ...
    func switchView(isHide: Bool, view: UIView, errorTextFild: UITextField, errorText: String) {
        DispatchQueue.main.async {
            if (isHide) {
                ...
                self.confirmTextFild.layer.borderWidth = 0
            }
